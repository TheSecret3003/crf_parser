...
def main():
    ...
    subparser.add_argument('--train', default='data/ptb/Train.clean', help='path to train file')
    subparser.add_argument('--dev', default='data/ptb/Dev.clean', help='path to dev file')
    subparser.add_argument('--test', default='data/ptb/Test.clean', help='path to test file')
    ...
    subparser.add_argument('--bert', default='indobert-base-p1', help='which BERT model to use')
    # evaluate
