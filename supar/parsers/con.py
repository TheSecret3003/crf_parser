...
class CRFConstituencyParser(Parser):
    ...
    def train(self, train, dev, test, buckets=32, batch_size=3, update_steps=1,
              mbr=True,
              delete={'TOP', 'S1', '-NONE-', ',', ':', '``', "''", '.', '?', '!', ''},
              equal={'ADVP': 'PRT'},
              verbose=True,
        ...
        Args:
            ...
            batch_size (int):
                The number of tokens in each batch. Default: 3.
            update_steps (int):
    ...
    def evaluate(self, data, buckets=8, batch_size=3, mbr=True,
                 delete={'TOP', 'S1', '-NONE-', ',', ':', '``', "''", '.', '?', '!', ''},
                 equal={'ADVP': 'PRT'},
                 verbose=True,
                 **kwargs):
    ...
    def predict(self, data, pred=None, lang=None, buckets=8, batch_size=3, prob=False, mbr=True, verbose=True, **kwargs):
        r"""
        Args:
...
class VIConstituencyParser(CRFConstituencyParser):
    ...
    def evaluate(self, data, buckets=8, batch_size=3,
                 delete={'TOP', 'S1', '-NONE-', ',', ':', '``', "''", '.', '?', '!', ''},
                 equal={'ADVP': 'PRT'},
                 verbose=True,
                 **kwargs):
    ...
    def predict(self, data, pred=None, lang=None, buckets=8, batch_size=3, prob=False,  verbose=True, **kwargs):
        r"""
        Args:
            data (list[list] or str):
                The data for prediction, both a list of instances and filename are allowed.
